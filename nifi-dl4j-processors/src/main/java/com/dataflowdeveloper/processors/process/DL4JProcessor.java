...
@Tags({ "dl4jprocessor" })
@CapabilityDescription("Run DL4J Image Recognition")
@SeeAlso({})
@ReadsAttributes({ @ReadsAttribute(attribute = "imgpath", description = "imgpath") })
@WritesAttributes({ @WritesAttribute(attribute = "probabilities", description = "probabilities") })
/**
 * 
 * @author tspann
 *
 */
public class DL4JProcessor extends AbstractProcessor {
